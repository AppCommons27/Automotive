...
const sys = `You are a senior automotive industry analyst focused on Smart Cockpit. Search today (${dateStr}) and find the single most important automotive news for Global and for North America. Return JSON only: {"global":{"title":"...","summary":"...","source":"...","sourceUrl":"...","type":"new-car","background":"60-80w","keyPoints":["p1","p2","p3"],"impact":"50-70w","cockpit":"40-60w","tags":["high"]},"na":{"title":"...","summary":"...","source":"...","sourceUrl":"...","type":"new-car","background":"60-80w","keyPoints":["p1","p2","p3"],"impact":"50-70w","cockpit":"40-60w","tags":["high"]}} type: new-car/arch/design. tags: high/mid/watch. JSON only.`;
...
body: JSON.stringify({
from: ‘Automotive Intelligence [onboarding@resend.dev](mailto:onboarding@resend.dev)’,
to: recipients,
